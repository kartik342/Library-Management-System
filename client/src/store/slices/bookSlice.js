...
export const fetchAllBooks = () => async (dispatch) => {
    ...
    await axios.get(`${import.meta.env.VITE_API_URL}/api/v1/book/all`, {withCredentials: true})
    .then((res ) => {
...
export const addBook = (data) => async (dispatch) => {
    ...
    await axios.post(`${import.meta.env.VITE_API_URL}/api/v1/book/admin/add`, data, {
