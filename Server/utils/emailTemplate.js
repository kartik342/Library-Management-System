    ...
    return `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #000; color: #fff;">
            ...
            <footer style="margin-top: 20px; text-align: center;">
                ...
                <p style="font-size: 14px; color: #666;">Thank you,<br />BookWorm Team</p>
...
export function generateForgotPasswordEmailTemplate(resetPasswordUrl){
    return `
        ...
        <p style="font-size: 16px; color: #ccc;">You have requested to reset your password. Please click the button below to proceed:</p>
        ...
        <p style="font-size: 14px; color: #aaa; word-break: break-all;">
            ${resetPasswordUrl}
        </p>
